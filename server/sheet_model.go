...
type CellValue struct {
	...
	Ff FlexString  `json:"ff,omitempty" bson:"ff,omitempty"` // 字体类型
...
type CalcChain struct {
	...
	Index   FlexString    `json:"index,omitempty" bson:"index,omitempty"`
