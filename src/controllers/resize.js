...
import { $$, getObjType, camel2split, debugLog } from "../utils/util";
...
export default function luckysheetsizeauto(isRefreshCanvas = true) {
  ...
  let ismore = false,
    ...
    morediv =
      ...
      (Store.infobarHeight +
        ...
        $("body").scrollTop()) +
      'px;right:0;z-index:1003;padding:5.5px;visibility:hidden;height:auto;white-space:initial;"></div>';
  ...
  debugLog('luckysheetsizeauto-lockedAreaShow');
  lockedAreaShow();
...
export function changeSheetContainerSize(gridW, gridH) {
  ...
  debugLog('from',Store.cellmainHeight,Store.cellmainWidth);
  ...
  debugLog('to',Store.cellmainHeight,Store.cellmainWidth);
